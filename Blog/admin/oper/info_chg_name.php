...
if(isset($user_id)){
    ...
    $show_origin = "select username from user_info where useremail = '$user_id'";
    $result = mysqli_query($databaseConnection,$show_origin);
    $row = mysqli_fetch_array($result);
}
if(isset($_GET["username_new"])){
    $username_new = $_GET["username_new"];
   $sql = "update user_info set username = '$username_new' where useremail = '$user_id'"; 
            ...
            <article id="main">
                ...
                <section class="wrapper style5">
                    <div class="inner" style="margin:auto">
                        <form method="get" action="info_chg_name.php">
                            <div class="row gtr-uniform">
                                <div class="col-6 col-12-xsmall">
                                     <input type="text" name="id" id="sign_name" value="<?= $row["username"]?>" readonly="readonly">
                                    <input type="text" name="username_new" id="sign_name" value="" placeholder="New Name">
                                </div>
                                <p>&nbsp;</p>
                                <div class="col-12">
                                    <ul class="actions">
